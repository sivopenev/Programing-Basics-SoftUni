    ...
    public static void main(String[] args) {
        ...
        for (int n = 0; true; n++) {
            for (int i = 0; i < username.length() ; i++) {
                ...
                // проверява всеки символ от юзернейма за наличие на забранен от зададените
                        username.chars();
                ...
                for (int j = 0; j < blockedSymbols.length; j++) {
                    ...
                    if (badSymbols == symbol){  // при наличие на забранен символ булевата става тру и влиза в иф проверката долу
                        isIllegal = true;
                        break;
                    }
                }
